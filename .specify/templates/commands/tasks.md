...
3. Include tests for any sim/domain logic or validation changes (tests are required).
4. Include documentation tasks for behavior changes (MkDocs).
...
## Notes
- Tests use pytest and must be written to fail before implementation.
